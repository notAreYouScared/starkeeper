                    ...
                    <div class="mt-1.5 flex items-center gap-2">
                        @if($member->profile_url)
                            <a href="{{ $member->profile_url }}"
                               ...
                               class="inline-flex items-center justify-center h-8 w-8 rounded-full bg-indigo-600/20 hover:bg-indigo-600/40 text-indigo-400 hover:text-indigo-300 transition-colors">
                        ...
                        @if($member->rsi_handle)
                            <a href="https://robertsspaceindustries.com/en/citizens/{{ $member->rsi_handle }}"
                               ...
                               title="RSI Profile"
                               class="inline-flex items-center justify-center h-8 w-8 rounded-full bg-blue-400/10 hover:bg-blue-400/20 text-blue-400 hover:text-blue-300 transition-colors">
